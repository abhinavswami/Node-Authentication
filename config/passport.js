...
module.exports = function(passport) {
  ...
  passport.use('local-login', new LocalStrategy({
      // by default local strategy uses usernameand password, we will override it to use password
      usernameField: 'email',
    ...
    function(req, email, password, done) { // callback with email and password
      ...
      User.findOne({
        ...
        // if no user found, return the messages
        if (!user)
          return done(null, false, req.flash('loginMessage', 'No user found.'));
        // if there is a user foun but tpassword is wrong
